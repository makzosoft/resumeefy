...
async function responsesJson<T>(input: unknown, schema: JsonSchema, schemaName: string, instructions: string): Promise<T> {
  if (DEMO_MODE) {
    ...
    const demo: Record<string, unknown> = {
      ...
      resumeefy_blog: { title:"How to Prepare for Your Next Career Opportunity", excerpt:"Practical steps for getting your application and interview readiness in shape.", content:"## Start with the role
...
Treat each application as feedback. Review what worked, improve what did not, and keep your materials aligned with the role.", topic:"career preparation", coverType:"gradient", slug:"demo-career-preparation", seoTitle:"How to Prepare for Your Next Career Opportunity", seoDescription:"Practical career preparation steps for job seekers.", primaryKeyword:"career preparation", searchIntent:"informational", recommendedService:"interview", softCta:"When you are ready to practise, Resumeefy can help you rehearse realistic interview questions." },
